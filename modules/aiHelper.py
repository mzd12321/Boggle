...
class AIHelper:
    ...
    def __init__(self):
        ...
        self.beam_width = 5
        self.max_word_length = 15  # Prevent infinite searches
    ...
    def _search_with_threshold(self, board, found_words, threshold):
        ...
        def search_from_tile(start_row, start_col):
            ...
            result = self._beam_search(board, start_row, start_col, found_words, threshold)
            if result[0] is not None:
                with results_lock:
    ...
    def _beam_search(self, board, start_row, start_col, found_words, threshold):
        """
